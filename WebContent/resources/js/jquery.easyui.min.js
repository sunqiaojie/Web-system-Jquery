...
$("<div class=\"datagrid-header-check\"></div>").html("<input type=\"checkbox\" style=\"vertical-align:middle\" />").appendTo(td);
}else{
if(col.field){
td.attr("field",col.field);
...
$(_5cd)._outerWidth(_5ce);
    ...
    var _5d1 = $("<input type=\"checkbox\" style=\"vertical-align:middle\" >").appendTo(_5cf);
_5d1.val(_5d0.on);
...
cc.push("\">");
if(col.checkbox){
    cc.push("<input type=\"checkbox\" style=\"vertical-align:middle\" name=\"" + _643 + "\" value=\"" + (_644 != undefined ? _644 : "") + "\"/>");
}else{
if(col.formatter){
...
if(col.checkbox){
if(row.checked){
    cc.push("<input type=\"checkbox\" style=\"vertical-align:middle\" checked=\"checked\"");
}else{
    cc.push("<input type=\"checkbox\" style=\"vertical-align:middle\"");
}
